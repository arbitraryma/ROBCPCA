...
CPCA.R is coded based on the description of 'Multivariate time series clustering based on common principal component analysis' by Hailin Li as a benchmark of our method. 
...
'noise function AR(2) mixing.R' added noises from t-distribution with df=3 to some time points, as a way to generate outliers
